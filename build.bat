...
SET src_dir=src
SET tests_dir=tests
SET source_files=%src_dir%\371todo.cpp %src_dir%\todolist.cpp %src_dir%\project.cpp %src_dir%\task.cpp %src_dir%\date.cpp
SET main_file=%src_dir%\main.cpp
SET executable=%bin_dir%\371todo.exe
...
IF %testStr%==test (
  ...
  SET executable=%bin_dir%\371todo-test.exe
